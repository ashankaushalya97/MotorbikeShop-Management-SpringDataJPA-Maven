...
//            }
            ...
            JasperReport mainjasperReport = (JasperReport) JRLoader.loadObject(this.getClass().getResourceAsStream("/lk/ijse/dep/lk.ijse.dep.rcrmoto/reports/placeOrder.jasper"));
